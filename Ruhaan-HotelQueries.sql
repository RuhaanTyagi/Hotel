...
/*
-- A query that returns a list of reservations that end in July 2023,
...
/*
A query that returns a list of all reservations for rooms with a jacuzzi, 
...
/*
A query that returns all the rooms reserved for a specific guest, including the guest's name, the room(s) reserved,
...
WHERE Guest.FirstNAme = 'Hafsa' AND Guest.LastName = 'Degmaster'
 ...
 /*
 4. A query that returns a list of rooms, reservation ID, and per-room cost for each reservation. 
 ...
 */
 ...
 /*
 5. A query that returns all the rooms accommodating at least three guests and that are reserved on any date in April 2023.
...
/*
6. A query that returns a list of all guest names and the number of reservations per guest,
...
/*
7. A query that displays the name, address, and phone number of a guest based on their phone number.
